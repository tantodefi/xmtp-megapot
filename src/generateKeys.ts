...
import { generateEncryptionKeyHex } from "./helpers/client.js";
...
console.log("Generating keys for MegaPot agent...");
...
// Get the current working directory (should be the megapot agent directory)
const exampleDir = process.cwd();
const exampleName = exampleDir.split("/").pop() || "megapot";
...
// Write the .env file to the megapot agent directory
